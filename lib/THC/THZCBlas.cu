...
void THZCudaBlas_swap(THCState *state, long n, float *x, long incx, float *y, long incy)
{
  if(n == 1)
  {
    incx = 1;
...
void THZCudaBlas_scal(THCState *state, long n, float a, float *x, long incx)
{
  if(n == 1)
    incx = 1;
...
void THZCudaBlas_copy(THCState *state, long n, float *x, long incx, float *y, long incy)
{
  if(n == 1)
  {
    incx = 1;
...
void THZCudaBlas_axpy(THCState *state, long n, float a, float *x, long incx, float *y, long incy)
{
    if(n == 1)
  {
    incx = 1;
...
float THZCudaBlas_dot(THCState *state, long n, float *x, long incx, float *y, long incy)
{
  if(n == 1)
  {
    incx = 1;
...
/* Level 2 */
void THZCudaBlas_gemv(THCState *state, char trans, long m, long n, float alpha, float *a, long lda, float *x, long incx, float beta, float *y, long incy)
{
  if(n == 1)
    lda = m;
...
void THZCudaBlas_ger(THCState *state, long m, long n, float alpha, float *x, long incx, float *y, long incy, float *a, long lda)
{
  if(n == 1)
    lda = m;
...
/* Level 3 */
void THZCudaBlas_gemm(THCState *state, char transa, char transb, long m, long n, long k, float alpha, float *a, long lda, float *b, long ldb, float beta, float *c, long ldc)
{
