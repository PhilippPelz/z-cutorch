...
THZC_API void THZCudaTensor_normDim(THCState *state, THZCudaTensor *self, THZCudaTensor *src, float value, long dimension);
...
THZC_API void THZCudaTensor_addmm(THCState *state, THZCudaTensor *self, cx beta, THZCudaTensor *t, cx alpha, THZCudaTensor *mat1,
		THZCudaTensor *mat2);
...
cx beta, THZCudaTensor *t, cx alpha, THZCudaTensor *batch1, THZCudaTensor *batch2);
...
THZC_API void THZCudaTensor_log10(THCState *state, THZCudaTensor *self, THZCudaTensor *src);
...
THZC_API void THZCudaTensor_acosh(THCState *state, THZCudaTensor *self, THZCudaTensor *src);
...
THZC_API void THZCudaTensor_asinh(THCState *state, THZCudaTensor *self, THZCudaTensor *src);
...
THZC_API void THZCudaTensor_atanh(THCState *state, THZCudaTensor *self, THZCudaTensor *src);
...
THZC_API void THZCudaTensor_abs(THCState *state, THCudaTensor *self, THZCudaTensor *src);
THZC_API void THZCudaTensor_arg(THCState *state, THCudaTensor *self, THZCudaTensor *src);
THZC_API void THZCudaTensor_norm(THCState *state, THCudaTensor *self, THZCudaTensor *src);

THZC_API void THZCudaTensor_real(THCState *state, THCudaTensor *self, THZCudaTensor *src);
THZC_API void THZCudaTensor_imag(THCState *state, THCudaTensor *self, THZCudaTensor *src);
...
// TensorScatterGather
THZC_API void THZCudaTensor_gather(THCState *state, THZCudaTensor *tensor, THZCudaTensor *src, int dim, THCudaTensor *index);
THZC_API void THZCudaTensor_scatter(THCState *state, THZCudaTensor *tensor, int dim, THCudaTensor *index, THZCudaTensor *src);
THZC_API void THZCudaTensor_scatterFill(THCState *state, THZCudaTensor *tensor, int dim, THCudaTensor *index, cx value);
THZC_API void THZCudaTensor_scatterFill(THCState *state, THZCudaTensor *tensor, int dim, THCudaTensor *index, cx value);
...
// TensorIndex
THC_API void THCudaTensor_indexCopy(THCState *state, THZCudaTensor *res_, int dim, THCudaTensor *indices, THZCudaTensor *src);
THC_API void THCudaTensor_indexAdd(THCState *state, THZCudaTensor *res_, int dim, THCudaTensor *indices, THZCudaTensor *src);
THC_API void THCudaTensor_indexFill(THCState *state, THZCudaTensor *tensor, int dim, THCudaTensor *index, cx val);
THC_API void THCudaTensor_indexSelect(THCState *state, THZCudaTensor *tensor, THZCudaTensor *src, int dim, THCudaTensor *index);
