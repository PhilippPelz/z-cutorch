...
THZC_API void THZCudaTensor_fill(THCState *state, THZCudaTensor *self, float value);
...
THZC_API void THZCudaTensor_cpow(THCState *state, THZCudaTensor *self, THZCudaTensor *src1, THZCudaTensor *src2);
...
THZC_API float THZCudaTensor_dot(THCState *state, THZCudaTensor *self, THZCudaTensor *src);
...
THZC_API float THZCudaTensor_sumall(THCState *state, THZCudaTensor *self);
THZC_API float THZCudaTensor_prodall(THCState *state, THZCudaTensor *self);
...
THZC_API float THZCudaTensor_meanall(THCState *state, THZCudaTensor *self);
...
THZC_API void THZCudaTensor_rand(THCState *state, THZCudaTensor *r_, THLongStorage *size);
THZC_API void THZCudaTensor_randn(THCState *state, THZCudaTensor *r_, THLongStorage *size);
...
THZC_API void THZCudaTensor_indexFill(THCState *state, THZCudaTensor *tensor, int dim, THZCudaTensor *index, float val);
...
THZC_API void THZCudaTensor_maskedFill(THCState *state, THZCudaTensor *tensor, THZCudaTensor *mask, float value);
THZC_API void THZCudaTensor_maskedCopy(THCState *state, THZCudaTensor *tensor, THZCudaTensor *mask, THZCudaTensor *src);
THZC_API void THZCudaTensor_maskedSelect(THCState *state, THZCudaTensor *tensor, THZCudaTensor *src, THZCudaTensor *mask);
