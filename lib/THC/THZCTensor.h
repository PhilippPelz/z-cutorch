...
THZC_API void THZCudaTensor_set1d(THCState *state, THZCudaTensor *tensor, long x0, cx value);
THZC_API void THZCudaTensor_set2d(THCState *state, THZCudaTensor *tensor, long x0, long x1, cx value);
THZC_API void THZCudaTensor_set3d(THCState *state, THZCudaTensor *tensor, long x0, long x1, long x2, cx value);
THZC_API void THZCudaTensor_set4d(THCState *state, THZCudaTensor *tensor, long x0, long x1, long x2, long x3, cx value);

THZC_API cx THZCudaTensor_get1d(THCState *state, const THZCudaTensor *tensor, long x0);
THZC_API cx THZCudaTensor_get2d(THCState *state, const THZCudaTensor *tensor, long x0, long x1);
THZC_API cx THZCudaTensor_get3d(THCState *state, const THZCudaTensor *tensor, long x0, long x1, long x2);
THZC_API cx THZCudaTensor_get4d(THCState *state, const THZCudaTensor *tensor, long x0, long x1, long x2, long x3);
