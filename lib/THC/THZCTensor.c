...
// #include "THZCTensorCopy.cu"
#include "THZCGeneral.h"
#include "THZCTensor.h"
#include "THAtomic.h"

/**** access methods ****/
THZCudaStorage *THZCudaTensor_storage(THCState *state,
                                      const THZCudaTensor *self) {
  return self->storage;
}
...
cx *THZCudaTensor_data(THCState *state, const THZCudaTensor *self) {
  if (self->storage)
    return (cx *)(self->storage->data + self->storageOffset);
  else
    return NULL;
}
cux *THZCudaTensor_dataCu(THCState *state, const THZCudaTensor *self) {
  if (self->storage)
    return (self->storage->data + self->storageOffset);
  else
    return NULL;
}
void THZCudaTensor_setFlag(THCState *state, THZCudaTensor *self,
                           const char flag) {
  self->flag |= flag;
}

void THZCudaTensor_clearFlag(THCState *state, THZCudaTensor *self,
                             const char flag) {
  self->flag &= ~flag;
}
...
static void THZCudaTensor_rawSet(THCState *state, THZCudaTensor *self,
                                 THZCudaStorage *storage, long storageOffset,
                                 int nDimension, long *size, long *stride);
...
THZCudaTensor *THZCudaTensor_newWithTensor(THCState *state,
  ...
  THZCudaTensor *self = (THZCudaTensor *)THAlloc(sizeof(THZCudaTensor));
  THZCudaTensor_rawInit(state, self);
  THZCudaTensor_rawSet(state, self, tensor->storage, tensor->storageOffset,
                       tensor->nDimension, tensor->size, tensor->stride);
  return self;
}

/* Storage init */
THZCudaTensor *THZCudaTensor_newWithStorage(THCState *state,
  ...
  THZCudaTensor_rawInit(state, self);
  THZCudaTensor_rawSet(state, self, storage, storageOffset,
...
THZCudaTensor *THZCudaTensor_newWithStorage1d(THCState *state,
                                              THZCudaStorage *storage,
                                              long storageOffset, long size0,
                                              long stride0) {
  return THZCudaTensor_newWithStorage4d(state, storage, storageOffset, size0,
                                        stride0, -1, -1, -1, -1, -1, -1);
}

THZCudaTensor *THZCudaTensor_newWithStorage2d(THCState *state,
                                              THZCudaStorage *storage,
                                              long storageOffset, long size0,
                                              long stride0, long size1,
                                              long stride1) {
  return THZCudaTensor_newWithStorage4d(state, storage, storageOffset, size0,
                                        stride0, size1, stride1, -1, -1, -1,
                                        -1);
}

THZCudaTensor *THZCudaTensor_newWithStorage3d(
    THCState *state, THZCudaStorage *storage, long storageOffset, long size0,
    long stride0, long size1, long stride1, long size2, long stride2) {
  return THZCudaTensor_newWithStorage4d(state, storage, storageOffset, size0,
                                        stride0, size1, stride1, size2, stride2,
                                        -1, -1);
}

THZCudaTensor *
THZCudaTensor_newWithStorage4d(THCState *state, THZCudaStorage *storage,
                               long storageOffset, long size0, long stride0,
                               long size1, long stride1, long size2,
                               long stride2, long size3, long stride3) {
...
THZCudaTensor *THZCudaTensor_newWithSize(THCState *state, THLongStorage *size,
                                         THLongStorage *stride) {
...
THZCudaTensor *THZCudaTensor_newWithSize2d(THCState *state, long size0,
                                           long size1) {
  return THZCudaTensor_newWithSize4d(state, size0, size1, -1, -1);
}

THZCudaTensor *THZCudaTensor_newWithSize3d(THCState *state, long size0,
                                           long size1, long size2) {
  return THZCudaTensor_newWithSize4d(state, size0, size1, size2, -1);
}

THZCudaTensor *THZCudaTensor_newWithSize4d(THCState *state, long size0,
...
THZCudaTensor *THZCudaTensor_newContiguous(THCState *state,
                                           THZCudaTensor *self) {
...
THZCudaTensor *THZCudaTensor_newSelect(THCState *state, THZCudaTensor *tensor,
...
THZCudaTensor *THZCudaTensor_newTranspose(THCState *state,
                                          THZCudaTensor *tensor,
...
THZCudaTensor *THZCudaTensor_newUnfold(THCState *state, THZCudaTensor *tensor,
...
/* Resize */
void THZCudaTensor_resize(THCState *state, THZCudaTensor *self,
                          THLongStorage *size, THLongStorage *stride) {
  THArgCheck(size != NULL, 2, "invalid size");
  if (stride)
    THArgCheck(stride->size == size->size, 3, "invalid stride");

  THZCudaTensor_rawResize(state, self, size->size, size->data,
                          (stride ? stride->data : NULL));
}

void THZCudaTensor_resizeAs(THCState *state, THZCudaTensor *self,
                            THZCudaTensor *src) {
  int isSame = 0;
  int d;
...
void THZCudaTensor_resize1d(THCState *state, THZCudaTensor *tensor,
                            long size0) {
  THZCudaTensor_resize4d(state, tensor, size0, -1, -1, -1);
}

void THZCudaTensor_resize2d(THCState *state, THZCudaTensor *tensor, long size0,
                            long size1) {
  THZCudaTensor_resize4d(state, tensor, size0, size1, -1, -1);
}

void THZCudaTensor_resize3d(THCState *state, THZCudaTensor *tensor, long size0,
                            long size1, long size2) {
  THZCudaTensor_resize4d(state, tensor, size0, size1, size2, -1);
}

void THZCudaTensor_resize4d(THCState *state, THZCudaTensor *self, long size0,
                            long size1, long size2, long size3) {
  long size[4] = {size0, size1, size2, size3};
...
void THZCudaTensor_resize5d(THCState *state, THZCudaTensor *self, long size0,
                            long size1, long size2, long size3, long size4) {
  long size[5] = {size0, size1, size2, size3, size4};

  THZCudaTensor_rawResize(state, self, 5, size, NULL);
}

void THZCudaTensor_set(THCState *state, THZCudaTensor *self,
                       THZCudaTensor *src) {
  if (self != src)
    THZCudaTensor_rawSet(state, self, src->storage, src->storageOffset,
                         src->nDimension, src->size, src->stride);
}

void THZCudaTensor_setStorage(THCState *state, THZCudaTensor *self,
                              THZCudaStorage *storage_, long storageOffset_,
                              THLongStorage *size_, THLongStorage *stride_) {
  if (size_ && stride_)
    THArgCheck(size_->size == stride_->size, 5,
               "inconsistent size/stride sizes");

  THZCudaTensor_rawSet(state, self, storage_, storageOffset_,
                       (size_ ? size_->size : (stride_ ? stride_->size : 0)),
                       (size_ ? size_->data : NULL),
                       (stride_ ? stride_->data : NULL));
}

void THZCudaTensor_setStorage1d(THCState *state, THZCudaTensor *self,
                                THZCudaStorage *storage_, long storageOffset_,
                                long size0_, long stride0_) {
  THZCudaTensor_setStorage4d(state, self, storage_, storageOffset_, size0_,
                             stride0_, -1, -1, -1, -1, -1, -1);
}

void THZCudaTensor_setStorage2d(THCState *state, THZCudaTensor *self,
                                THZCudaStorage *storage_, long storageOffset_,
                                long size0_, long stride0_, long size1_,
                                long stride1_) {
  THZCudaTensor_setStorage4d(state, self, storage_, storageOffset_, size0_,
                             stride0_, size1_, stride1_, -1, -1, -1, -1);
}

void THZCudaTensor_setStorage3d(THCState *state, THZCudaTensor *self,
                                THZCudaStorage *storage_, long storageOffset_,
                                long size0_, long stride0_, long size1_,
                                long stride1_, long size2_, long stride2_) {
  THZCudaTensor_setStorage4d(state, self, storage_, storageOffset_, size0_,
                             stride0_, size1_, stride1_, size2_, stride2_, -1,
                             -1);
}

void THZCudaTensor_setStorage4d(THCState *state, THZCudaTensor *self,
                                THZCudaStorage *storage_, long storageOffset_,
                                long size0_, long stride0_, long size1_,
                                long stride1_, long size2_, long stride2_,
...
void THZCudaTensor_narrow(THCState *state, THZCudaTensor *self,
                          THZCudaTensor *src, int dimension, long firstIndex,
                          long size) {
  if (!src)
    src = self;

  THArgCheck((dimension >= 0) && (dimension < src->nDimension), 3,
             "out of range");
  THArgCheck((firstIndex >= 0) && (firstIndex < src->size[dimension]), 4,
             "out of range");
  THArgCheck((size > 0) && (firstIndex + size <= src->size[dimension]), 5,
             "out of range");
...
void THZCudaTensor_select(THCState *state, THZCudaTensor *self,
                          THZCudaTensor *src, int dimension, long sliceIndex) {
  int d;
  ...
  THArgCheck((dimension >= 0) && (dimension < src->nDimension), 3,
             "out of range");
  THArgCheck((sliceIndex >= 0) && (sliceIndex < src->size[dimension]), 4,
             "out of range");
...
void THZCudaTensor_transpose(THCState *state, THZCudaTensor *self,
                             THZCudaTensor *src, int dimension1,
                             int dimension2) {
  long z;
  ...
  THArgCheck((dimension1 >= 0) && (dimension1 < src->nDimension), 1,
             "out of range");
  THArgCheck((dimension2 >= 0) && (dimension2 < src->nDimension), 2,
             "out of range");
...
void THZCudaTensor_unfold(THCState *state, THZCudaTensor *self,
                          THZCudaTensor *src, int dimension, long size,
                          long step) {
  long *newSize;
  long *newStride;
  int d;
...
void THZCudaTensor_squeeze(THCState *state, THZCudaTensor *self,
                           THZCudaTensor *src) {
  int ndim = 0;
  int d;
...
void THZCudaTensor_squeeze1d(THCState *state, THZCudaTensor *self,
                             THZCudaTensor *src, int dimension) {
  int d;
...
int THZCudaTensor_isSameSizeAs(THCState *state, const THZCudaTensor *self,
                               const THZCudaTensor *src) {
  int d;
  if (self->nDimension != src->nDimension)
    return 0;
  for (d = 0; d < self->nDimension; ++d) {
...
int THZCudaTensor_isSameSizeAsZF(THCState *state, const THZCudaTensor *self,
                                 const THCudaTensor *src) {
  int d;
  if (self->nDimension != src->nDimension)
    return 0;
  for (d = 0; d < self->nDimension; ++d) {
...
void THZCudaTensor_freeCopyTo(THCState *state, THZCudaTensor *self,
                              THZCudaTensor *dst) {
  if (self != dst)
...
void THZCudaTensor_rawResize(THCState *state, THZCudaTensor *self,
                             int nDimension, long *size, long *stride) {
  int d;
  int nDimension_;
  long totalSize;
  ...
  for (d = 0; d < nDimension; d++) {
    if (size[d] > 0) {
      ...
      if ((self->nDimension > d) && stride && (stride[d] >= 0) &&
  ...
  if (nDimension > 0) {
    ...
    if (totalSize + self->storageOffset > 0) {
      ...
      if (totalSize + self->storageOffset > self->storage->size)
        THZCudaStorage_resize(state, self->storage,
...
void THZCudaTensor_set1d(THCState *state, THZCudaTensor *tensor, long x0,
                         cx value) {
  THArgCheck(tensor->nDimension == 1, 1, "tensor must have one dimension");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]), 2, "out of range");
  THZCudaStorage_set(state, tensor->storage,
                     tensor->storageOffset + x0 * tensor->stride[0], value);
}

cx THZCudaTensor_get1d(THCState *state, const THZCudaTensor *tensor, long x0) {
  THArgCheck(tensor->nDimension == 1, 1, "tensor must have one dimension");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]), 2, "out of range");
  return THZCudaStorage_get(state, tensor->storage,
                            tensor->storageOffset + x0 * tensor->stride[0]);
}

void THZCudaTensor_set2d(THCState *state, THZCudaTensor *tensor, long x0,
                         long x1, cx value) {
  THArgCheck(tensor->nDimension == 2, 1, "tensor must have two dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]),
             2, "out of range");
  THZCudaStorage_set(state, tensor->storage,
                     tensor->storageOffset + x0 * tensor->stride[0] +
...
cx THZCudaTensor_get2d(THCState *state, const THZCudaTensor *tensor, long x0,
                       long x1) {
  THArgCheck(tensor->nDimension == 2, 1, "tensor must have two dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]),
             2, "out of range");
  return THZCudaStorage_get(state, tensor->storage, tensor->storageOffset +
                                                        x0 * tensor->stride[0] +
                                                        x1 * tensor->stride[1]);
}

void THZCudaTensor_set3d(THCState *state, THZCudaTensor *tensor, long x0,
                         long x1, long x2, cx value) {
  THArgCheck(tensor->nDimension == 3, 1, "tensor must have three dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]) && (x2 >= 0) && (x2 < tensor->size[2]),
             2, "out of range");
  THZCudaStorage_set(state, tensor->storage,
                     tensor->storageOffset + x0 * tensor->stride[0] +
                         x1 * tensor->stride[1] + x2 * tensor->stride[2],
                     value);
}

cx THZCudaTensor_get3d(THCState *state, const THZCudaTensor *tensor, long x0,
                       long x1, long x2) {
  THArgCheck(tensor->nDimension == 3, 1, "tensor must have three dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]) && (x2 >= 0) && (x2 < tensor->size[2]),
...
void THZCudaTensor_set4d(THCState *state, THZCudaTensor *tensor, long x0,
                         long x1, long x2, long x3, cx value) {
  THArgCheck(tensor->nDimension == 4, 1, "tensor must have four dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]) && (x2 >= 0) &&
                 (x2 < tensor->size[2]) && (x3 >= 0) && (x3 < tensor->size[3]),
             2, "out of range");
  THZCudaStorage_set(state, tensor->storage,
                     tensor->storageOffset + x0 * tensor->stride[0] +
                         x1 * tensor->stride[1] + x2 * tensor->stride[2] +
...
cx THZCudaTensor_get4d(THCState *state, const THZCudaTensor *tensor, long x0,
                       long x1, long x2, long x3) {
  THArgCheck(tensor->nDimension == 4, 1, "tensor must have four dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]) && (x2 >= 0) &&
                 (x2 < tensor->size[2]) && (x3 >= 0) && (x3 < tensor->size[3]),
             2, "out of range");
  return THZCudaStorage_get(
      state, tensor->storage,
      tensor->storageOffset + x0 * tensor->stride[0] + x1 * tensor->stride[1] +
          x2 * tensor->stride[2] + x3 * tensor->stride[3]);
}
